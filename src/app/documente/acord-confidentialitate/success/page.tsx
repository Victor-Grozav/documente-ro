    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="max-w-lg w-full text-center">
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-green-200 dark:border-green-700 p-8 mb-6">
          ...
          <p className="text-gray-500 dark:text-slate-400 mb-6">Acordul tau este gata. Descarca PDF-ul de mai jos.</p>
          <PDFDownloadButton
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 p-6 text-left">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-500 dark:text-slate-400">Partea 1</span>
              <span className="font-medium dark:text-white">{data.parte1Nume}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 dark:text-slate-400">Partea 2</span>
              <span className="font-medium dark:text-white">{data.parte2Nume}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 dark:text-slate-400">Durata</span>
              <span className="font-medium dark:text-white">{data.durataAni} ani</span>
            </div>
            <div className="flex justify-between">
