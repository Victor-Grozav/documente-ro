...
const SAMPLE_IMPUTERNICIRE: ImputernicireData = {
  ...
  mandatarNume: "Popescu Elena",
  mandatarCNP: "2780808120008",
  mandatarCI: "CJ 111222",
  mandatarAdresa: "Str. Moților nr. 3, Cluj-Napoca, Cluj",
  obiect: "Să mă reprezinte în fața oricărei instituții publice sau private în vederea depunerii și ridicării de documente, semnării de acte administrative și oricăror alte operațiuni necesare în numele meu, pe teritoriul României.",
